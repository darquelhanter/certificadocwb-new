...
export const PaymentModal: React.FC<PaymentModalProps> = ({ planTitle, planPrice, onClose }) => {
    ...
    try {
      const response = await fetch('/api/create-payment', {
        ...
        body: JSON.stringify({
          ...
          description: `${planTitle} - Certificado CWB`,
        }),
      });
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">R$ {planPrice} · Cartão ou Pix</p>
            </div>
          </div>
